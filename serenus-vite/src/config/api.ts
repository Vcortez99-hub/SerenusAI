...
export const API_BASE_URL = isProduction
  ? import.meta.env.VITE_API_URL || '' // Em produção, usa URL relativa se não especificada
  : '/api' // Em desenvolvimento, usa proxy do Vite

// URL completa (com protocolo e domínio) - útil para health checks
export const API_FULL_URL = import.meta.env.VITE_API_URL || 'http://localhost:3001'
